...
-------------------------
عمليات إدارة التاجات (Tags): عرض، إضافة، حذف.
 
ليش انضاف هذا الملف؟
قبل كذا كومبوننت TagManager.jsx بالفرونت اند كان "يمثل" بس - يضيف ويحذف
تاجات بذاكرة المتصفح بدون ما يوصل أي شي لقاعدة البيانات فعليًا. هذا الملف
هو الجزء الناقص اللي يخلي TagManager يحفظ فعليًا.
"""
